...
public class GenerateHoliday {
	public static void main(String[] args) throws Exception {
		...
		// HoursWorked";
		String filePath = "emp_holiday_june.csv";
		int timeoutMiutes = 5;
		OkHttpClient client = new OkHttpClient().newBuilder()
				.callTimeout(timeoutMiutes, java.util.concurrent.TimeUnit.MINUTES).build();
		MediaType mediaType = MediaType.parse("application/json");
		String jsonString = "{ \"model\": \"gpt-3.5-turbo\",\"messages\":[{ \"role\":\"user\",\"content\":\"Provide example csv dataset for only 2 holiday in june month with header as HolidayDate Day HolidayName Type, where date format ir dd-mm-yyyy and Type is 'public'\"}]}";
