...
/*
 * Generating the Employee Profile with headers like - 
 * EmployeeName, EmployeeID, Designation, Billing(Billable/Non-Billable)
 * 
 * */
public class GenerateEmpProfile {

	public static void main(String[] args) throws Exception {

		// Initializing ApiKey, FilePath, Prompt
		String apiKey = "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";
		String filePath = "TestFolder\\EmpProfile.csv";
